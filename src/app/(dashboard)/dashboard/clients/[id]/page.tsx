          ...
          {client.documents.length === 0 ? (
            ...
            <div className="space-y-2">
              {client.documents.map((doc) => (
                <Link key={doc.id} href={`/dashboard/${doc.docType.toLowerCase().replace("_", "-")}s/${doc.id}`} className="flex items-center justify-between p-3 rounded-md border hover:bg-muted/50 transition-colors">
                  <div>
